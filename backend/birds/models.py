...
class Ring(models.Model):
    ...
    size = models.CharField(max_length=3, choices=RingSizes.choices, default=RingSizes.V,
                            verbose_name=_("Ringgröße"))
...
class DataEntry(models.Model):
    ...
    ringing_station = models.ForeignKey(RingingStation, on_delete=models.SET_NULL, verbose_name=_("Station"), null=True, blank=True)
    ...
    net_direction = models.CharField(max_length=1, choices=Direction.choices,
                                     verbose_name=_("Flugrichtung"), null=True, blank=True)
    feather_span = models.DecimalField(max_digits=6, decimal_places=2, verbose_name=_("Federl. (mm)"), null=True, blank=True)
    wing_span = models.DecimalField(max_digits=6, decimal_places=2, verbose_name=_("Flügell. (mm)"), null=True, blank=True)
    tarsus = models.DecimalField(max_digits=6, decimal_places=2, verbose_name=_("Tarsus. (mm)"), null=True, blank=True)
    notch_f2 = models.DecimalField(max_digits=6, decimal_places=2, verbose_name=_("Kerbe F2 (mm)"), null=True, blank=True)
    inner_foot = models.DecimalField(max_digits=6, decimal_places=2, verbose_name=_("Innenfuß (mm)"), null=True, blank=True)
    weight_gram = models.DecimalField(max_digits=7, decimal_places=2, verbose_name=_("Gewicht (g)"), null=True, blank=True)
    bird_status = models.CharField(max_length=1, choices=BirdStatus.choices, default=BirdStatus.FIRST_CATCH,
                                   verbose_name=_("Status"))
    fat_deposit = models.PositiveSmallIntegerField(null=True, blank=True)
    muscle_class = models.PositiveSmallIntegerField(choices=MuscleClass.choices, default=None,
                                                    verbose_name=_("Muskelklasse"), null=True, blank=True)
    age_class = models.PositiveSmallIntegerField(choices=AgeClass.choices, default=AgeClass.UNKNOWN,
                                                 verbose_name=_("Alter"))
    sex = models.PositiveSmallIntegerField(choices=Sex.choices, default=Sex.UNKNOWN, verbose_name=_("Geschlecht"))
    small_feather_int = models.PositiveSmallIntegerField(choices=SmallFeatherIntMoult.choices,
                                                         default=None, verbose_name=_("Kleingef. Int"), null=True, blank=True)
    small_feather_app = models.CharField(max_length=1, choices=SmallFeatherAppMoult.choices,
                                         default=None, verbose_name=_("Kleingef. Forts."), null=True, blank=True)
    hand_wing = models.PositiveSmallIntegerField(choices=HandWingMoult.choices, default=None,
                                                 verbose_name=_("Handschwinge"), null=True, blank=True)
    ...
    comment = models.CharField(max_length=2048, verbose_name=_("Bemerkungen"), null=True, blank=True)
...
class SpeciesList(models.Model):
    ...
    is_active = models.BooleanField(
        default=False,
        verbose_name=_("Active for Autocomplete")
    )
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
