 ...
 * mit ihm. Nur `ProjectActionsService` hält einen, weil dort die Geste selbst in
 * einem Dienst wohnt (Projekt-Anlage und -Bearbeitung) — und auch dort zeigt ihn
 * der Bildschirm, auf dem gedrückt wurde.
 *
